...
public class AddFilesWithAESEncryption {
	...
	public AddFilesWithAESEncryption() {
		...
		try {
			...
			ZipFile zipFile = new ZipFile("f:\\ZipTest\\AddFilesWithAESZipEncryption.zip");
			
			// Build the list of files to be added in the array list
			// Objects of type File have to be added to the ArrayList
			ArrayList filesToAdd = new ArrayList();
			filesToAdd.add(new File("f:\\ZipTest\\sample.txt"));
			filesToAdd.add(new File("f:\\ZipTest\\myvideo.avi"));
			filesToAdd.add(new File("f:\\ZipTest\\mysong.mp3"));
