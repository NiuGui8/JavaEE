...
public class EmailManager {
    ...
    public static String username = "liucunliang@szlabsun.com"; // 服务邮箱(from邮箱)
    public static String password = "labsun2017"; // 邮箱密码
    public static String senderNick = "朗石科技";   // 发件人昵称
    ...
    public EmailManager() {
        ...
        props.put("mail.smtp.host", "smtp.szlabsun.com");
...
//          mimeMsg.setFrom(new InternetAddress(from));
    ...
    public static void main(String[] args) {
        ...
        String[] to = {"630942328@qq.com", "630942328@qq.com"};
        String[] copyto = {"liu_cl8888@163.com"};
        String subject = "测试一下";
        String content = "<p>这是邮件内容</p><p>仅仅是测试，</p>不需要回复.";
        String[] fileList = new String[1];
        fileList[0] = "C:\\Users\\Administrator\\Desktop\\软件开发部-刘存良-2017年12月-第48周工作总结与计划 .xls";
